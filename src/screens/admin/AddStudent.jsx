...
import { ADD_STUDENT } from "../../services/AdminServices";
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.heroCard}>
          ...
          <Text style={styles.heroTitle}>New Student</Text>

          <Text style={styles.heroSub}>
            Register student details and grant access instantly.
          </Text>
        </View>
