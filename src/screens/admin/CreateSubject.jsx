...
import { CREATE_SUBJECT } from "../../services/AdminServices";
...
const [loading, setLoading] = useState(false);
  ...
  const handleCreateSubject = async () => {
    ...
    setLoading(true);
    try {
      const result = await CREATE_SUBJECT(subjectData);
      ...
      if (result.success) {
        ...
        Alert.alert("Error", result.message || "Failed to create subject");
      }
    } catch (error) {
      setLoading(false);
