...
import { UPDATE_TEACHER } from "../../services/AdminServices";

const EditTeacher = ({ navigation, route }) => {
  const { teacher } = route.params || {};

  const [name, setName] = useState(teacher?.teacher?.fullName || "");
  ...
  const handleUpdateTeacher = async () => {
    ...
    try {
      ...
      const res = await UPDATE_TEACHER(teacher._id, {
        name,
        email,
        employeeId,
        department,
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.heroCard}>
          ...
          <Text style={styles.heroTitle}>Edit Teacher</Text>
        ...
        <View style={styles.formCard}>
          ...
          >
            {loading ? (
              ...
              <>
                <Text style={styles.submitText}>Update Teacher</Text>
